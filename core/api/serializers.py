...
from core.models import Item, OrderItem, Order, Coupon, Variation, ItemVariation, Address, Payment
...
class ItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Item
        fields = (
            'id', 'title', 'price', 'discount_price', 'category', 'label', 'slug', 'description', 'image'
        )
...
class ItemDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Item
        fields = (
            'id', 'title', 'price', 'discount_price', 'category', 'label', 'slug', 'description', 'image', 'variations'
        )
